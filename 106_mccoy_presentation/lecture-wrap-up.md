...
- Labor-intensive production; essential lesson: **sometimes you can't assess if an idea works until you see it through completely**
...
- Includes an operatic section with 10-minute song about marketing (lyrics from internet)
- Explores luxury spaces and late capitalism
...
## Approach to Production & Problem-Solving

- **Setting rules**: Often establish constraints to define projects (e.g., every cut in Starsky & Hutch equals original editor's choices)
- **Elaborate production processes**: Accept that you can't assess success until completion
- **Hands-on technical innovation**: Kevin writes custom software; both collaborate on mechanical and engineering challenges
- **Scale as creative tool**: Work across different scales (tiny miniatures to large installations)
- **Future-proofing**: Deliberately plan for technological evolution and preservation

---

## Keys to Longevity in Art Practice

1. **Collaboration as strategy**: Breaking down divisions between art and life
2. **Focus on practice over market**: Let professionalization be downstream
3. **Commitment to ideas over outcomes**: Trust the process even with uncertainty
4. **Conservation & preservation mindset**: Work with institutions and conservators; recognize that digital media requires ongoing care
5. **Staying curious**: Engage with emerging technologies (blockchain, NFTs) as artists rather than dismissing them
6. **Finding institutional support**: Museums, galleries, and professional conservators enable complex work to survive and thrive

---

## Visiting Artist Purpose (per Haber's intro)

- Show the **arc of a career**: how one project leads to the next
- Demonstrate that there are many ways to be an artist and move through the art world
- Provide a roadmap for emerging artists to imagine their own paths
- Enable students to identify themes and approaches that resonate with their own practice
