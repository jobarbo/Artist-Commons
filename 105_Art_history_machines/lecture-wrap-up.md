...
This lecture traces a **conceptual history of "optical orders"**—how different eras construct different logics of seeing. Rather than following a strict timeline, it explores how vision operates, what consequences arise, and what possibilities emerge when technology transforms how we see.

**Key Insight:** Seeing is not a biological act—it's cultural. Every era has its own **optical order** that defines how we see and what counts as real.

---

## 📐 Part 1: The View From Above - Perspective as Power
...
- The painted image emerged seamlessly with reality

**Modern Parallels:** Viewfinder, camera, VR headset, camera obscura, photography, 3D scanners

### What Perspective Changed
...
**Leonardo da Vinci's Imola Map (1502):** Unlike medieval maps centered on symbolic meaning, this used strict bird's-eye view. Commissioned by Cesare Borgia not to admire space, but to **control it**.
...
**Heidegger's Critique:** Modern humans no longer encounter things as beings—they see them as resources. Forests become timber inventory, rivers become hydropower. **Vision becomes a tool for capitalism.**
...
**Key Takeaway:** Seeing is never neutral. Linear perspective reorganized the world into something measurable, ownable, governable. Artists respond by mimicking power's viewpoints to expose the logic.

---

## 📷 Part 2: The Mechanical Eye - Photography and the Optical Unconscious
...
**Dziga Vertov's "Kino-eye":** The camera's mechanical eye was more perfect than the human eye

**Walter Benjamin's "Optical Unconscious":** Just as Freud revealed unconscious desires driving behavior, the camera exposed unconscious structures within vision

**Artists Expanding Vision:**
...
**Key Instruments:** Microscopes, telescopes, kaleidoscopes, X-rays, aerial photography, infrared, radio waves—all extensions of the photographic principle
...
**19th Century Literal:** Families posed deceased children for post-mortem photographs—mechanical images began to replace lived memory
...
- Private memory becomes repeatable pattern—**life becomes a data set**
...
**1898 Example:** Photographers bribed their way into Otto von Bismarck's death chamber. Images circulated through newspapers, reaching mourning crowds who had never been present in life. The photograph didn't merely record history—**it manufactured a historical event**.
...
**Baudrillard's "Simulacra":** A world where copies no longer refer to originals—reality is completely replaced by representation
...
- Exposes our dependency: we need events to justify attention

---

## 📺 Part 6: Television - The Living Room Ideology Machine

### The Scale of Penetration

- 1953: 2/3 of American households owned TV
- 1960s: Almost 90%
- Average viewer: Hours every day in front of screen

**Susan Sontag (1977):** The rise of **"aesthetic consumerism"**—people need reality confirmed and experience intensified through images. To live increasingly meant to consume life photographically.

### Early Video Artists Fight Back

**Sony Portapak (1975):** First affordable handheld video camera—artists could record and display without film laboratories or broadcast studios
...
- **TV Buddha:** Bronze Buddha watches itself watching itself in infinite loop—enlightenment caught in endless self-observation
...
**Key Takeaway:** Images stopped documenting events and began producing them. Montage, broadcast, and mass media revealed: **whoever controls image sequence controls attention, thus controls reality**.
...
### Lev Manovich's Database Logic

Once photography showed reality can be frozen, cinema taught reality can be assembled through montage. **What does digital media do?**
...
2. **Modularity:** Digital elements remain independent building blocks (clips, pixels, files can be rearranged without destroying whole)
3. **Automation:** Software can operate on images automatically
4. **Variability:** No digital image has singular form—can be resized, recolored, recompressed, regenerated endlessly
5. **Transcoding:** Images exist simultaneously as visual culture AND computer data
...
**Key Takeaway:** Images are no longer visible things communicating content. They are modular elements that can be stored, sorted, recombined, generated. Meaning emerges from structure, correlation, permutation. **The image is no longer something we look at—it's something that runs.**

---

## 🎯 Conclusion: The Evolution of Vision

### Historical Progression

1. **Renaissance:** Vision became measurement—to see is to possess. Human observer at center of world
2. **Mechanical Eye:** Machines revealed what human eye cannot see. Reality expanded but slipped out of our hands
3. **Memory & Archive:** Images began to remember. Past left our minds, entered archives/screens/networks
4. **Spectacle:** Images stopped recording events, began producing them—shaping story, beliefs, identities
5. **Data:** Images became modular, generative, automated—no longer singular story, don't need single author
...
**The Task of Artists Today:** Not simply to produce images, but to **interrupt the regimes of vision that produce us**
...
> "Perspective is not a natural law, it is a choice." — David Hockney

> "We cannot tolerate randomness—we turn it into meaning." — Dr. Polina Rud

> "The medium is the message." — Marshall McLuhan

> "Television does not deliver programs to audiences. It delivers audiences to advertisers." — Richard Serra

> "Nothing new can be created" is a thought we cannot allow—we must search for unfinished experiments

---

## 📚 Essential Insight

**The fundamental challenge:** If we believe nothing new can be created, we are done as artists. We need art history to search for **unfinished experiments**—to continue what hasn't been completed yet, to develop what can be different.

Vision has always been shaped by technology and power. Artists' role is to expose these regimes, hijack these systems, and reveal new ways of seeing that resist being reduced to control, consumption, or computation.
