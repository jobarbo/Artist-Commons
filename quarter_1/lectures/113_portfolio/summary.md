...
A portfolio is not a comprehensive record. It is not a career retrospective. It is not your greatest hits dropped into a folder. It is a **designed viewing experience with a beginning, middle, and end** — specifically:

> **An edited selection of your best work, designed for a specific viewer and a specific purpose.**

Your portfolio is a **portable, temporary exhibition of your current thinking as an artist**. You are not gathering images. You are constructing an experience.

---

## 1. Audience & Purpose First

**An archive preserves. A portfolio persuades.**

Your portfolio is a tool to help someone make a decision: to invite you, hire you, fund you, exhibit you. That is its job.

The key question to hold through every decision you make:

> **"What decision do I want them to make after five minutes with my work?"**
...
A portfolio answers one question: **Who is this artist today?**
...
Coherence can come from any of these — not only from visual style. These threads are the core of your practice; the works that anchor to them are the ones to build around.

> **The most common portfolio failure is not weak work. It's a lack of coherence — an illegible artistic practice.**
...
- **Vary the rhythm.** Alternate between dense and simple, dark and light, large and small, quiet and complex — so works don't blur together
- **Avoid redundancy.** If two works do the same thing, include only the stronger one
- **End strong.** The closing work should feel significant and memorable, and suggest a direction for where the work is heading. Don't end with a whimper
...
- Formal contexts (admissions, residencies, galleries) need easy parsing
...
- You have enough work to sustain the complexity (generally: more established artists)

Weaving is structurally more demanding. If the relationships between projects aren't immediately clear, the portfolio will feel chaotic — the opposite of what you want.
...
- **Material connections** — threading practice through questions each medium unlocks
- **Narrative frame** — hook, deepen, pivot, climax, resolution across four acts
- **Anchors and satellites** — open with a central defining work, surround it with supporting works

No single method is correct. Take the words that resonate and run with them.

---

## 5. Two Mediums in the Same Portfolio
...
**Exception:** For medium-specific residencies or opportunities, lead with the most relevant medium and consider leaving others out. Research past participants to understand what types of artists they have selected, at what career stage, and in what mediums.
...
- Lead with **Selected Works** — the 3–6 most important pieces right now, not a complete timeline
- Put a small "view full archive" link at the bottom for those who want to go deeper
- First-time visitors should get foundational facts quickly; confusion drives people away
...
- Simple over decorative — the work is the focus; design should not compete with it
...
- Number images with leading zeros: `01`, `02`, `03` (not `1`, `10`, `2`)
...
- Medium should be specific: not "mixed media" but "oil, acrylic, and graphite on canvas"
- Titles matter — they help identify work and can make meaning. Untitled is fine as a conceptual choice, but don't just leave work unnamed by default
- Captions identify; they do not explain. Long explanations belong in the artist statement, not the caption
...
- Cropped cleanly; no studio clutter, damaged walls, or unrelated objects
...
- **A portfolio is not an archive. It persuades.** Its job is to help someone make a specific decision in your favor
- **There is no single definitive portfolio.** You customize to audience and purpose every time
- **The most common failure is not weak work — it's incoherence.** Find the through line (method, material, questions, emotional tone) and build around it
- **Start strong; end strong.** Decisions happen in the first 1–3 images. Don't make a reviewer overcome a disappointing opening
- **Sequence is meaning.** The order of works shapes how they're understood — treat it like curating a show
- **Early career: group by project.** Weaving requires consistency and depth that comes with more work
- **Documentation is not a formality.** It communicates how seriously you take your own work
- **Replace, don't add.** Keep the count tight; every image must earn its place
- **Getting turned down is often about fit, not quality.** Jury taste is not the final word on your work

---

## Reflection Questions

1. **The key question:** What decision do you want your primary target audience (a residency, grant, gallery, or program) to make after five minutes with your portfolio? Does your current selection and sequence lead them toward that decision?

2. **The through line:** Looking at your recent bodies of work side by side, what recurring elements — material, method, question, emotional tone — thread them together? Are those threads visible to someone who doesn't know your work?

3. **The cut:** Is there a piece in your portfolio (or one you keep considering adding) that you'd hesitate to defend if asked why it's there? What would you lose if you removed it?

4. **Grouping vs. weaving:** Based on where you are in your practice right now, does your work call for the clarity of grouping by project, or does it benefit from the connections revealed by weaving? What does that choice say about where your practice is?

5. **The opening work:** What is the first image a reviewer would see in your portfolio? Does it represent your practice clearly, establish confidence, and make them want to keep going?
